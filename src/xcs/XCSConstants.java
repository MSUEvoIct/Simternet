 ...
 * other experimental settings and flags. Most parameter-names are chosen
 * similar to the 'An Algorithmic Description of XCS' ( Butz&Wilson, IlliGAL
 * report 2000017).
 * 
...
public class XCSConstants implements Serializable {
	 ...
	 * the multiplexer problem this value is set to 400, 800, 2000 in the 6, 11,
	 * 20 multiplexer resp.. In the Woods1 and Woods2 environment the parameter
	 * was set to 800.
	 */
	...
	/**
	 * The reduction of the prediction error when generating an offspring
	 * classifier.
	 */
	...
	/**
	 * The initialization of the pseudo random generator. Must be at lest one
	 * and smaller than _M.
	 */
	private static long seed = 1;

	/**
	 * The maximal number of steps executed in one trial in a multi-step
	 * problem.
	 */
	...
	public static double drand() {
		long hi = XCSConstants.seed / XCSConstants._Q;
		long lo = XCSConstants.seed % XCSConstants._Q;
		long test = XCSConstants._A * lo - XCSConstants._R * hi;
