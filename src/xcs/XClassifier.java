...
public class XClassifier implements Serializable {
	...
	public boolean isMoreGeneral(XClassifier cl) {
		...
		for (int i = 0; i < length; i++)
			if ((this.condition.charAt(i) != XCSConstants.dontCare)
	...
	public void printXClassifier() {
		System.out.println(this.condition + " " + this.action + "\t" + (float) this.prediction + "\t"
				+ (float) this.predictionError + "\t" + (float) this.fitness + "\t" + this.numerosity + "\t"
				+ this.experience + "\t" + (float) this.actionSetSize + "\t" + this.timeStamp);
	}
	...
	public void printXClassifier(PrintWriter pW) {
		pW.println(this.condition + "-" + this.action + " " + (float) this.prediction + " "
				+ (float) this.predictionError + " " + (float) this.fitness + " " + this.numerosity + " "
				+ this.experience + " " + (float) this.actionSetSize + " " + this.timeStamp);
	}
	...
	public double updatePreError(double P) {
		if (this.experience < 1. / XCSConstants.beta)
			this.predictionError = (this.predictionError * (this.experience - 1.) + Math.abs(P - this.prediction))
					/ this.experience;
		else
